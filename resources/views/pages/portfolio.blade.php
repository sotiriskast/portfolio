        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web filter-app">
                <div class="portfolio-wrap">
                    <img src="assets/img/portfolio/cementart.png" class="img-fluid" alt="">
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/cementart.png" data-gallery="portfolioGallery"
                           class="portfolio-lightbox" title="Website Cement Art Design"><i class="bx bx-plus"></i></a>
                        <a href="https://cementart.com.cy/" target="_blank" title="More Details"><i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <img src="assets/img/portfolio/mamakido.png" class="img-fluid" alt="">
                    <div class="portfolio-links">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-links">
                        ...
                        {{--                                <a href="http://tour-excursion.atwebpages.com" target="_blank" title="More Details"><i class="bx bx-link"></i></a>--}}
                    </div>
                </div>
            </div>
                ...
                <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery"
                           class="portfolio-lightbox" title="Website"><i class="bx bx-plus"></i></a>
                        {{--                                <a href="http://eventscy.com/" target="_blank" title="More Details"><i class="bx bx-link"></i></a>--}}
                    </div>
                </div>
            </div>
                ...
                <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery"
                           class="portfolio-lightbox" title="Website"><i class="bx bx-plus"></i></a>
                        {{--                                <a href="http://vrissiana.atwebpages.com/" target="_blank"  title="More Details"><i class="bx bx-link"></i></a>--}}
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    ...
                    <div class="portfolio-links">
                        ...
                        {{--                                <a href="http://empower-mental.atwebpages.com/" title="More Details"><i class="bx bx-link"></i></a>--}}
                    </div>
                </div>
            </div>

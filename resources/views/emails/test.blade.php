                                                ...
                                                <tr>
                                                    <td role="modules-container"
                                                        ...
                                                        <table class="module" role="module" data-type="divider"
                                                               ...
                                                               data-muid="0cbf4946-d84a-410f-aa2e-5bbcf2774aed">
                                                            <tbody>
                                                            <tr>
                                                        ...
                                                        <table class="module" role="module" data-type="spacer"
                                                               border="0" cellpadding="0" cellspacing="0" width="100%"
                                                               style="table-layout: fixed;"
                                                               data-muid="f2202182-adb5-45c7-a1f2-0e6ff8e755cf">
                                                            <tbody>
                                                            <tr>
                                                                <td style="padding:0px 0px 61px 0px;"
                                                        ...
                                                        <table class="module" role="module" data-type="text"
                                                               border="0" cellpadding="0" cellspacing="0" width="100%"
                                                               style="table-layout: fixed;"
                                                               data-muid="19da2fbb-a209-428f-b89d-419bb23e5508">
                                                            <tbody>
                                                            <tr>
                                                                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    role="module-content">
                                                                    <div>
                                                                        <div style="font-family: inherit">You
                                                        ...
                                                        <table class="module" role="module" data-type="text"
                                                               border="0" cellpadding="0" cellspacing="0" width="100%"
                                                               style="table-layout: fixed;"
                                                               data-muid="1c47e9ef-edda-476e-b465-e55b4820cb98">
                                                            <tbody>
                                                            <tr>
                                                                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                                    height="100%" valign="top" bgcolor=""
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                               ...
                                                               data-muid="22d348a3-a57c-4115-affb-e384de88d31e">
                                                            <tbody>
                                                            <tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center"
                                                                                ...
                                                                                <a mailto=" {{ $data['email'] }}"
                                                                                   style="background-color:#333333; border:1px solid #333333; border-color:#333333; border-radius:6px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid;"
